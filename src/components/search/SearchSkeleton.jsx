...
const SearchSkeleton = () => {
  return (
    <div className="overflow-hidden rounded-3xl border-y border-l border-r border-neutral-500 p-0 lg:flex lg:h-auto lg:w-full lg:flex-row lg:items-center lg:justify-start lg:gap-5 lg:rounded-none lg:border-y-0 lg:border-r-0 lg:bg-neutral-100 lg:p-2">
      <Skeleton
        variant="rectangular"
