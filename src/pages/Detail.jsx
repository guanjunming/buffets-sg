        ...
        <div className="mx-auto max-w-4xl p-6">
          <div className="flex flex-col gap-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm md:flex-row">
            <div className="flex-1 border-r border-gray-200 pr-4">
              <h2 className="mb-2 text-sm-custom font-semibold">ABOUT</h2>
            ...
            <div className="flex-1 border-r border-gray-200 px-4">
              <h2 className="mb-2 text-sm-custom font-semibold">DETAILS</h2>
              ...
              <div className="mt-4">
                ...
                {restaurant.cuisine.map((cuisine, index) => (
                  <span
                    key={index}
                    className="mr-1 rounded-sm bg-blue-400 px-1 py-1 text-sm-custom2 text-white"
                  >
                    {cuisine}
                  </span>
                ))}
            ...
            <div className="flex-1 pl-4">
              <h2 className="mb-2 text-sm-custom font-semibold">
                RATINGS & REVIEWS
              </h2>
              <div className="my-4 border-t border-gray-300">
                <strong>
                  <p className="mt-4 text-2xl-custom">4.5/5</p>
                </strong>
              </div>
        ...
        <div className="text-sm-custom">
          <div className="mx-auto max-w-4xl p-6">
            <div className="md:flex-column flex flex-col gap-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
              ...
              >
                <h2 className="mb-2 text-sm-custom font-semibold">REVIEWS</h2>
              </div>
